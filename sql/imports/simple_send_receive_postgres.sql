-- Simple PostgreSQL schema + data for send/receive (users, messages, submissions, ratings)
-- Run: psql postgresql://user:pass@host:5432/dbname -f simple_send_receive_postgres.sql

-- Note: This file is Postgres-compatible. It intentionally does NOT use SQLite PRAGMA.
...
-- Ensure SERIAL sequences are set to the max(id) so future inserts without id work
